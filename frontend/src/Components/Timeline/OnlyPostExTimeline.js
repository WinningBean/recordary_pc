...
import OnlyPostExComment from './OnlyPostExComment';
...
const OnlyPostExTimeline = (props) => {
    ...
    <div className='timeline' style={data.groupFK !== null ? { borderTop: '4px solid tomato' } : null}>
      ...
      <div className='timeline-info' style={{ height: 'auto' }}>
        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
          ...
          >
            <div style={{ margin: '10px 0px' }}>{data.postEx}</div>
          </div>
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginLeft: '10px' }}>
              <div className='comment-icon-left'>
                <div className='likeIcon'>
                  <ThumbUpRoundedIcon
                    style={
                      data.currentUserLikePost ? { color: 'rgba(20, 81, 51, 0.9)', fontSize: 25 } : { fontSize: 25 }
                    }
                    onClick={async () => {
                      try {
            ...
            <div className='comment-write' style={{ marginBottom: '10px' }}>
              <OnlyPostExComment
                user={props.user}
                postCd={data.postCd}
        ...
        <div
          ...
          style={{ width: '350px', maxHeight: '225px', overflowY: 'auto', marginBottom: '10px' }}
        >
          <div style={{ overflowY: 'auto', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
...
export default OnlyPostExTimeline;
